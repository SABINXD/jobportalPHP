  ...
  <body>
    ...
    <section class="section__container job__container" id="job">
      ...
      <div class="job__grid">
        ...
        <div class="job__card">
          <div class="job__card__header">
            <img src="assets/img/google.png" alt="job" />
            <div>
              <h5>Google</h5>
              <h6>USA</h6>
            </div>
        ...
        <div class="job__card">
          <div class="job__card__header">
            <img src="assets/img/linkedin.png" alt="job" />
            <div>
              <h5>LinkedIn</h5>
              <h6>Germany</h6>
            </div>
        ...
        <div class="job__card">
          <div class="job__card__header">
            <img src="assets/img/amazon.png" alt="job" />
            <div>
              <h5>Amazon</h5>
              <h6>USA</h6>
            </div>
        ...
        <div class="job__card">
          <div class="job__card__header">
            <img src="assets/img/twitter.png" alt="job" />
            <div>
              <h5>Twitter</h5>
              <h6>USA</h6>
            </div>
        ...
        <div class="job__card">
          <div class="job__card__header">
            <img src="assets/img/microsoft.png" alt="job" />
            <div>
              <h5>Microsoft</h5>
              <h6>USA</h6>
            </div>
